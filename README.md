...
<img src="https://github.com/weizhao-BME/metis-project3/blob/main/figures/workflow2.png" alt="Figure 1" width="500"/>
...
In this analysis, important features that lenders focus on to make decisions on refinancing applications were identified. And how lenders use these features as a potential guideline to make decisions were explored. In the future, this work may be extended to employ nationwide data with more loan purposes. A more sophisticated deep neural network could be leveraged for a more complex classification. 
