...
<img src="https://github.com/weizhao-BME/metis-project3/blob/main/figures/hoepa_status_count.png" alt="Figure 5" width="300"/>

------

### **Conclusion**

In this analysis, important features that lenders focus on to make a decision on approval were identified. And how lenders use these features as a potential guideline to make a decision on approval were explored. In the future, this work may be extended to employ nationwide data with more loan purposes. A more sophisticated deep neural network could be leveraged for a more complex classification. 
